...
```zsh
setopt prompt_subst
PROMPT="${FG[246]}‹\${CONDA_DEFAULT_ENV}› ${FG[050]}%n%{$reset_color%} in ${FG[004]}%c%{$reset_color%}\$(virtualenv_prompt_info)\$(ruby_prompt_info)\$vcs_info_msg_0_${FG[147]} λ%{$reset_color%} "
